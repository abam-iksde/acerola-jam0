...
registerClass('textarea', createTextArea)
registerClass('button', createButton)
registerClass('slider', createSlider)
registerClass('checkbox', createCheckbox)
registerClass('div', createDiv)
